...
if space==" ":
  question_1=input("1. What is the difference between a raster image and a vector image\n a. They're the same type of picture but have different names\n b. A vector image is higher quality and a raster image has lower quality\nc. A raster image is higher quality and a vector image has lower quality")
